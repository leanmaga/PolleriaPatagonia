...
async function sendBasicTestEmail(testEmail) {
  const emailData = {
    to: testEmail,
    subject: "🧪 Test Básico - Sol Campestre",
...
async function sendVerificationTestEmail(testEmail) {
  ...
  const emailData = {
    to: testEmail,
    subject: "[PRUEBA] Verifica tu cuenta - Sol Campestre",
    html: `
      <!DOCTYPE html>
      <html lang="es">
      <head>
...
async function sendPasswordResetTestEmail(testEmail) {
  ...
  const emailData = {
    to: testEmail,
    subject: "[PRUEBA] Restablece tu contraseña - Sol Campestre",
    html: `
      <!DOCTYPE html>
      <html lang="es">
      <head>
...
async function sendOrderConfirmationTestEmail(testEmail) {
  ...
  const emailData = {
    to: testEmail,
    subject: "[PRUEBA] Confirmación de Pedido #TEST123 - Sol Campestre",
    html: `
      <!DOCTYPE html>
      <html lang="es">
      <head>
...
function getEmailFooter() {
  return `
    <div class="footer">
      <p style="margin: 0; font-size: 14px;">© ${new Date().getFullYear()} Sol Campestre - Sistema de Emails</p>
