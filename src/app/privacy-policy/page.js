        ...
        <div className="bg-white rounded-lg shadow-sm border p-8">
          <div className="prose prose-lg max-w-none">
            ...
            <p className="mb-4 text-gray-700">
              En Sol Campestre, nos comprometemos a proteger su privacidad. Esta
            ...
            <p className="mb-4 text-gray-700">
              Si Sol Campestre participa en una fusión, adquisición o venta de
              activos, su información personal puede ser transferida como parte
              de esa transacción.
            </p>
