        ...
        <div className="bg-white rounded-lg shadow-sm border p-8">
          <div className="prose prose-lg max-w-none">
            ...
            <p className="mb-4 text-gray-700">
              Bienvenido a Sol Campestre. Los siguientes términos y condiciones
              rigen el uso de nuestro sitio web y la compra de productos a
              través de nuestra plataforma. Al acceder a nuestro sitio web y
              utilizar nuestros servicios, usted acepta estar sujeto a estos
              términos y condiciones. Si no está de acuerdo con alguno de estos
              términos, le rogamos que no utilice nuestro sitio web.
            </p>
            ...
            <p className="mb-4 text-gray-700">
              Sol Campestre es una plataforma exclusivamente para la compra de
            ...
            <p className="mb-4 text-gray-700">
              En la medida permitida por la ley, Sol Campestre no será
              ...
              ingresos, ya sea directa o indirectamente, ni por cualquier
