...
const legalDocuments = {
  terms: {
    ...
    content: `
      ...
      <p class="mb-4">En la medida permitida por la ley, PolleríaPatagonia no será responsable por daños indirectos, incidentales, especiales, consecuentes o punitivos, ni por cualquier pérdida de beneficios o ingresos, ya sea directa o indirectamente, ni por cualquier pérdida de datos, uso, fondo de comercio u otras pérdidas intangibles.</p>
  ...
  privacy: {
    ...
    content: `
      ...
      <p class="mb-4">Si PolleríaPatagonia participa en una fusión, adquisición o venta de activos, su información personal puede ser transferida como parte de esa transacción.</p>
